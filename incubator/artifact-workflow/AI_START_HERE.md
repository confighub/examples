...
Use this page when you want to drive the incubator `artifact-workflow` example safely with an AI assistant.
...
```text
Read incubator/artifact-workflow/AI_START_HERE.md and walk me through the demo.
