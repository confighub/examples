...
# The Argo per-resource sync option is intentional. The 2026-04-23 live pass
# showed that relying only on Application-level ServerSideApply=true was
# insufficient for this oversized CRD in the observed Argo v3.3.8 setup, so the
# fixture carries the resource-level option documented by Argo as the safe
