...
script_checks=(
  ...
  "${repo_root}/incubator/springboot-platform-app-centric/setup.sh"
  "${repo_root}/incubator/springboot-platform-app-centric/verify.sh"
  "${repo_root}/incubator/springboot-platform-app-centric/cleanup.sh"
  "${repo_root}/incubator/springboot-platform-app-centric/demo.sh"
