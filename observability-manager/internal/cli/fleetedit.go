...
--param name=value. Dry-run unless --commit --change-desc.

Example: inject the otel sidecar into every prod workload —
  fleet-edit --profile otel-sidecar --environment prod --param image=otel/opentelemetry-collector:0.100 --commit --change-desc "…"`,
		Args: cobra.NoArgs,
