...
The repo has 28 `AI_START_HERE.md` files. A tick means the file follows this standard.

- [ ] `configboard/AI_START_HERE.md`
- [ ] `cost-estimator/AI_START_HERE.md`
- [ ] `cost-management-app/AI_START_HERE.md`
- [ ] `gitops/argo/beginner-app-of-apps/AI_START_HERE.md`
- [ ] `gitops/argo/beginner-applicationset/AI_START_HERE.md`
- [ ] `gitops/argo/expert-app-of-apps/AI_START_HERE.md`
- [ ] `gitops/argo/intermediate-git-as-database/AI_START_HERE.md`
- [ ] `gitops/flux/beginner/AI_START_HERE.md`
- [ ] `gitops/flux/expert-fleet/AI_START_HERE.md`
- [x] `global-app-layer/AI_START_HERE.md`
- [ ] `global-app-layer/bundle-evidence-sample/AI_START_HERE.md`
- [ ] `global-app-layer/enterprise-rag-blueprint/AI_START_HERE.md`
- [ ] `global-app-layer/frontend-postgres/AI_START_HERE.md`
- [ ] `global-app-layer/gpu-eks-h100-training/AI_START_HERE.md`
- [ ] `global-app-layer/realistic-app/AI_START_HERE.md`
- [x] `global-app-layer/single-component/AI_START_HERE.md`
- [ ] `initiatives-demo/AI_START_HERE.md`
- [ ] `pilot-example-addons-manager/AI_START_HERE.md`
- [ ] `promoter/AI_START_HERE.md`
- [ ] `promotion-demo-data/AI_START_HERE.md`
- [ ] `promotion-demo-data/verify/AI_START_HERE.md`
- [ ] `rbac-manager/AI_START_HERE.md`
- [ ] `redis-platform-with-rbac-guardrails/AI_START_HERE.md`
- [ ] `sec-scanner/AI_START_HERE.md`
- [ ] `spring-platform/AI_START_HERE.md`
...
- [ ] `spring-platform/springboot-platform-platform-centric/AI_START_HERE.md`
...
The goal: every example in this repo can be demoed by pasting one prompt,
