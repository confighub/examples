...
This doc explains the enforced contract for AI guides. The verifier (`scripts/verify.sh`) checks every example it lists.
...
- [ai-demo-pacing-standard.md](./ai-demo-pacing-standard.md) — Demo pacing standard
