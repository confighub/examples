#!/usr/bin/env bash
# setup.sh — Seed the rbac-manager demo fleet in ConfigHub
#
...
#
# Usage:
#   ./setup.sh                  # create everything (idempotent; safe to re-run)
#   ./setup.sh --explain        # print the plan, mutate nothing
#   ./setup.sh --explain-json   # print the plan as JSON, mutate nothing
#
...
Next: ./verify.sh confirms the seeded fleet, including that the planted
