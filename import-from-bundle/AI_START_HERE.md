...
Use this page when you want to drive the stable `import-from-bundle` example safely with an AI assistant.
...
```text
Read import-from-bundle/AI_START_HERE.md and walk me through the demo.
