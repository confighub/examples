...
Use this page when you want to drive the stable `connected-summary-storage` example safely with an AI assistant.
...
```text
Read connected-summary-storage/AI_START_HERE.md and walk me through the demo.
