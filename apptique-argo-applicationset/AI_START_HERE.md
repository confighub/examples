...
Use this page when you want to drive the stable `apptique-argo-applicationset` example safely with an AI assistant.
...
```text
Read apptique-argo-applicationset/AI_START_HERE.md and walk me through the demo.
