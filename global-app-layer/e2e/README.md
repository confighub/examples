...
```bash
# All three flows
./global-app-layer/e2e/run-all.sh

# Individual flows
./global-app-layer/e2e/run-all.sh brownfield
./global-app-layer/e2e/run-all.sh greenfield
./global-app-layer/e2e/run-all.sh bridge

# Or directly
./global-app-layer/e2e/01-brownfield.sh
./global-app-layer/e2e/02-greenfield.sh
./global-app-layer/e2e/03-bridge.sh
```

## Prerequisites

1. A running kind cluster: `global-app-layer/e2e/bin/create-cluster`
2. ArgoCD installed: `global-app-layer/e2e/bin/install-argocd`
3. Sample apps deployed: `global-app-layer/e2e/bin/setup-apps`
4. ConfigHub worker registered: `CUB_SPACE=<space> global-app-layer/e2e/bin/install-worker`
