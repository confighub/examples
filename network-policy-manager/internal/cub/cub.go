...
// Package cub is cub-netpol's gateway to ConfigHub: one authenticated session,
// built from the ambient cub credentials, shared by every command.
package cub
...
var session = cubapi.MemoizedClient{UserAgent: "cub-netpol"}
