...
- proves:
  ...
  - the output is generated by the `payments-rbac` app
...
- mutates: no
- output shape: empty on success
- proves:
  - the app can load the payments-platform fixture
  - the app recognizes the expected component, variants, Units, RBAC finding,
    and dry-run edit
