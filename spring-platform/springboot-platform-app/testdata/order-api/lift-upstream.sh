...
PAIRS=(
  ...
  "confighub/order-api-dev.yaml|$ROOT_DIR/confighub/order-api-dev.yaml|$BUNDLE_DIR/confighub/order-api-dev.yaml"
  "confighub/order-api-stage.yaml|$ROOT_DIR/confighub/order-api-stage.yaml|$BUNDLE_DIR/confighub/order-api-stage.yaml"
  "confighub/order-api-prod.yaml|$ROOT_DIR/confighub/order-api-prod.yaml|$BUNDLE_DIR/confighub/order-api-prod.yaml"
)
